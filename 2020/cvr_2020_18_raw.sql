START TRANSACTION;
DROP TABLE IF EXISTS `cvr_2020_18_raw`;
CREATE TABLE `cvr_2020_18_raw` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Cast vote record 2020 Queen Anne''s County';
