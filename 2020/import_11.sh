...
TABLE="cvr_2020_11_raw"

# Frederick
$MYSQL_CMD < ${TABLE}.sql || exit 1
$IMPORT_CMD --delete cvr2020 $TABLE "$IMPORT_PATH/11_Frederick/11PG20_Prov_CVR_SBE.csv"
$IMPORT_CMD cvr2020 $TABLE "$IMPORT_PATH/11_Frederick/11PG20_Prov_CVR_SBE - 1.csv"
