START TRANSACTION;
DROP TABLE IF EXISTS `cvr_2020_22_raw`;
CREATE TABLE `cvr_2020_22_raw` (
  ...
  `mayor_hagerstown` tinytext NOT NULL,
  `hagerstown_council_1` tinytext NOT NULL,
  `hagerstown_council_2` tinytext NOT NULL,
  `hagerstown_council_3` tinytext NOT NULL,
  `hagerstown_council_4` tinytext NOT NULL,
  `hagerstown_council_5` tinytext NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Cast vote record 2020 Washington County';
...
INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "mayor_hagerstown" FROM `race` WHERE name="Mayor of Hagerstown";

INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "hagerstown_council_1" FROM `race` WHERE name="Hagerstown Council";

INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "hagerstown_council_2" FROM `race` WHERE name="Hagerstown Council";

INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "hagerstown_council_3" FROM `race` WHERE name="Hagerstown Council";

INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "hagerstown_council_4" FROM `race` WHERE name="Hagerstown Council";

INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "hagerstown_council_5" FROM `race` WHERE name="Hagerstown Council";
...
INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "board_of_education_4" FROM `race` WHERE name="Board of Education";
