START TRANSACTION;
DROP TABLE IF EXISTS `cvr_2020_19_raw`;
CREATE TABLE `cvr_2020_19_raw` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Cast vote record 2020 Saint Mary''s County';
...
INSERT INTO `county_race` (`county_id`, `race_id`, `raw_column`)
SELECT @county_id, id, "board_of_education_at_large" FROM `race` WHERE name="Board of Education at Large";
